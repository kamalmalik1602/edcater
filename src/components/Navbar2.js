...
const Navbar2 = () => {
  ...
  <div className="scaffold-layout__inner scaffold-layout-container
      scaffold-layout-container--reflow
      ">


      <div className="scaffold-layout__row scaffold-layout__content
    ...
    <div className="onboarding-widget__wrapper">
      ...
      <h1 className="text-heading-xlarge pt6 pb3 ">Your profile helps you discover new people and opportunities</h1>

</div>

        
<section className="onboarding-profile-edu onboarding-widget__single-card-container mhA display-flex justify-center
            hidden">
  ...
  <div className="search-basic-typeahead search-vertical-typeahead onboarding-profile-typeahead__basic-typeahead relative">
    ...
    {/* <input id="typeahead-input-for-title" className="onboarding-profile-typeahead__input onboarding-input " role="combobox" aria-autocomplete="list" aria-activedescendant="" aria-expanded="false" type="text"></input> */}
    <div>
    <label className="onboarding-profile-form-field__label t-14 t-black--light t-normal mt0 truncate
    ...
    <div className="onboarding-profile-error-container">
</div>
</div>
